...
from invincat_cli.integrations.sandbox_factory import get_default_working_dir
...
def get_system_prompt(
    ...
    *,
    ...
    skills_path = f"~/.invincat/{assistant_id}/skills"
...
def create_cli_agent(
    ...
    *,
    ...
    # read the channel.
    from invincat_cli.token_state import TokenStateMiddleware
