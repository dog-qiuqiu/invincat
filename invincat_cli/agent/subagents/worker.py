...
WORKER_DESCRIPTION = (
    ...
    "and local refactors. Use this agent when the main agent can assign clear "
    "ownership of files or modules and wants the work done in parallel or in an "
    "isolated context. It should modify only its assigned scope, verify the "
    "change, and report touched files and results."
)
...
- Stay inside the assigned ownership boundary. If you need files outside that
  scope, explain why before proceeding.
