...
def list_skills(
    *,
    ...
    1. `user_skills_dir` (`~/.invincat/{agent}/skills/`)
    2. `user_agent_skills_dir` (`~/.agents/skills/`)
    3. `project_skills_dir` (`.invincat/skills/`)
    ...
    Args:
        ...
        user_skills_dir: Path to `~/.invincat/{agent}/skills/`.
        project_skills_dir: Path to `.invincat/skills/`.
