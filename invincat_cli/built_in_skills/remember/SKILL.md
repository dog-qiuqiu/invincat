...
**Global** (`~/.invincat/agent/AGENTS.md`): Universal preferences across all projects
**Project** (`.invincat/AGENTS.md`): Project-specific conventions and decisions
...
### Skill Location
`~/.invincat/agent/skills/<skill-name>/SKILL.md`
