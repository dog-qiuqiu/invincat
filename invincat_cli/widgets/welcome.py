...
def _get_tips() -> list[str]:
    ...
    Returns:
        List of translated tip strings.
    """
    return get_i18n().get_all_tips()


_TIPS: list[str] = _get_tips()
...
class WelcomeBanner(Static):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        tips = get_i18n().get_all_tips()
        self._tip: str = random.choice(tips) if tips else ""  # noqa: S311
    ...
    def _build_banner(self, project_url: str | None = None) -> Content:
        ...
        if self._failed:
            ...
            parts.append(build_welcome_footer(primary_color=ready_color))
...
def build_welcome_footer(
    *, primary_color: str = theme.PRIMARY, tip: str | None = None
    ...
    if tip is None:
        tips = get_i18n().get_all_tips()
        tip = random.choice(tips) if tips else ""  # noqa: S311
    return Content.assemble(
        (f"\n{t('welcome.ready')} What would you like to build?\n", primary_color),
