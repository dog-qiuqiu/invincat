...
class MessageData:
    ...
    """ID of the tool call, used to match ToolMessage results."""
        ...
        match self.type:
            ...
            case MessageType.TOOL:
                widget = ToolCallMessage(
                    ...
                    # Hydrated widgets always have their final args — mark them
                    # finalized so on_mount doesn't show "Generating..." briefly.
                    args_finalized=True,
                    id=self.id,
                )
