...
TRANSLATIONS: dict[str, dict[str, str]] = {
    Language.EN: {
        ...
        "memory.viewer.help": "1 user · 2 project · tab switch · r refresh · a toggle archived · esc close",
        "memory.viewer.title": "Memory Manager · Scope: {scope}",
    ...
    Language.ZH: {
        ...
        "memory.viewer.help": "1 用户 · 2 项目 · Tab 切换 · r 刷新 · a 切换归档显示 · Esc 关闭",
        "memory.viewer.title": "记忆管理 · 范围：{scope}",
