...
TRANSLATIONS: dict[str, dict[str, str]] = {
    Language.EN: {
        ...
        "command.plan": "/plan <task> - Generate a task plan for user approval",
        "plan.usage": "Usage: /plan <task description>",
    ...
    Language.ZH: {
        ...
        "command.plan": "/plan <任务> - 生成任务计划供用户确认",
        "plan.usage": "用法：/plan <任务描述>",
