...
TRANSLATIONS: dict[str, dict[str, str]] = {
    Language.EN: {
        ...
        "command.wecombot_daemon_start": "Start WeCom daemon (background, survives TUI exit)",
        "command.wecombot_daemon_stop": "Stop the background WeCom daemon",
        "command.wecombot_daemon_status": "Show background WeCom daemon status",
    ...
    Language.ZH: {
        ...
        "command.wecombot_daemon_start": "后台启动企业微信 daemon（TUI 退出后持续运行）",
        "command.wecombot_daemon_stop": "停止后台企业微信 daemon",
        "command.wecombot_daemon_status": "查看后台企业微信 daemon 状态",
