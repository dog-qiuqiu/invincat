...
TRANSLATIONS: dict[str, dict[str, str]] = {
    Language.EN: {
        ...
        "memory.viewer.help": "1 user · 2 project · tab switch · r refresh · a toggle archived · s sort · esc close",
    ...
    Language.ZH: {
        ...
        "memory.viewer.help": "1 用户 · 2 项目 · Tab 切换 · r 刷新 · a 切换归档显示 · s 排序 · Esc 关闭",
