...
TRANSLATIONS: dict[str, dict[str, str]] = {
    Language.EN: {
        ...
        "memory.viewer.delete.confirm": "Delete [{item_id}]? Press [d] again to confirm, or navigate away to cancel.",
    ...
    Language.ZH: {
        ...
        "memory.viewer.delete.confirm": "删除 [{item_id}]？再次按 [d] 确认，或移动光标取消。",
